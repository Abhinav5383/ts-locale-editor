...
export type TranslationFn_Body = StringNode | VariableNode | ArrayNode | TranslationFn_BlockExprBody; // raw code string of the function body
...
export type TranslationNodeUnion = StringNode | VariableNode | ArrayNode | ObjectNode | FunctionNode;
