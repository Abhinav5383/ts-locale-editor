...
export function StringRenderer(props: NodeRendererProps<StringNode>) {
	...
	return (
		<div class={`node-string ${isFullWidth() ? "full-width" : ""} ${hasNewLine() ? "multiline" : ""}`}>
			<Show
				...
				fallback={
					...
					>
						<StringPreview value={props.node.value} isStrTemplate={props.node.type === NodeType.StringTemplate} />
