...
export function Select(props: SelectProps) {
	...
	return (
		<Show
			...
			fallback={<RegularSelect id={props.id} options={props.options} value={props.value} onChange={props.onChange} />}
		>
			<FancySelect id={props.id} options={props.options} value={props.value} onChange={props.onChange} />
		</Show>
	);
}
